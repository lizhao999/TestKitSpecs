...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/theLizhao/TestKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'theLizhao' => 'theLizhao@163.com' }
  s.source           = { :git => 'https://github.com/theLizhao/TestKit.git', :tag => s.version.to_s }
